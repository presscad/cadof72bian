...
//用dwg图形名称（去掉后缀）做为关键字，保存对应的插入当前图面的块插入的Id
...
public:
	...
	mapBlockObjectId m_mapBlockIds;//已插入地形图图块的ID
...
protected:
	//CString m_strProjectCode; // 项目编号
	CString m_strProjectId;		// 项目ID
	CString m_strFileId;		// 文件ID
