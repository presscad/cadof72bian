...
public:
	...
	long CreateBlkRefAttr(AcDbObjectId& resultId,AcGePoint3d basePt,char* strBlkName,char* strLyName= "0",int  nClrIndex = 0,
		                  char *strScale="1.0#1.0#1.0#",double dAngle = 0.0,CString strAttValue="",AcDbDatabase* pDB= CURDBPOINTER);
...
public:
	...
	AcDbObjectId  CreateBlockByDwgFile(CString strBlkName,CString strDwgFileName);
};
