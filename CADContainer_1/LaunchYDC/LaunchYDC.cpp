...
BEGIN_MESSAGE_MAP(CLaunchYDCApp, CWinApp)
...
// 唯一的一个 CLaunchYDCApp 对象

CLaunchYDCApp theApp;
...
BOOL CLaunchYDCApp::InitInstance()
{
	...
	// 支持打开多个
	//HANDLE h = CreateEvent ( NULL, TRUE, FALSE, "SH-YDCSP-3AC01994-FD16-4F4F-9BA7-A5F27AE8CC76");
...
int CLaunchYDCApp::ExitInstance()
{
